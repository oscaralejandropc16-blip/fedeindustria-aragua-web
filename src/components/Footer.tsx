...
export default function Footer() {
  ...
  // Evitar mostrar el footer en las rutas de admin o panel privado para que no cause scroll en el dashboard
      ...
      <div className="max-w-7xl mx-auto px-8 grid grid-cols-1 md:grid-cols-12 gap-16 relative z-10">
        ...
        <div className="md:col-span-5 space-y-8">
          <div className="bg-white p-4 rounded-2xl inline-block shadow-xl shadow-black/20">
            <img src={logoUrl} alt="Logo Fedeindustria" className="h-20 w-auto object-contain" />
          </div>
