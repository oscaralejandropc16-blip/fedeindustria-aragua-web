          ...
          >
            ...
            >
              ...
              <div className="relative px-4 sm:px-8">
                <div className="absolute -top-12 sm:-top-16 left-4 sm:left-8 w-24 h-24 sm:w-32 sm:h-32 bg-white rounded-2xl sm:rounded-[2rem] p-3 sm:p-4 shadow-2xl shadow-black/60 border-4 sm:border-[6px] border-[#0a0f1c] flex items-center justify-center z-10 overflow-hidden">
