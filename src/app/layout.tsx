          ...
          <div className="max-w-7xl mx-auto px-8 grid grid-cols-1 md:grid-cols-12 gap-16 relative z-10">
            ...
            <div className="md:col-span-4 space-y-6">
              ...
              <div className="pt-6 flex gap-4">
                <a href="https://instagram.com/fedeindustriaaragua" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-white hover:bg-[#002b7f] hover:scale-110 hover:shadow-lg hover:shadow-blue-900/50 transition-all duration-300">
